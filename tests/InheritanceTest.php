...
class InheritanceTest extends AbstractTestCase
{
    ...
    public function testLoadCreateCountryEvent(int $eventId): void
    {
        ...
        self::assertSame(Event\CountryEvent\CreateCountryEvent::class, get_class($event));

        /** @var Event\CountryEvent\CreateCountryEvent $event */
        self::assertSame($eventId, $event->getId());
        self::assertSame(1234567890, $event->getTime());
        self::assertSame('FR', $event->getCountry()->getCode());
    ...
    public function testLoadEditCountryNameEvent(int $eventId): void
    {
        ...
        self::assertSame(Event\CountryEvent\EditCountryNameEvent::class, get_class($event));

        /** @var Event\CountryEvent\EditCountryNameEvent $event */
        self::assertSame($eventId, $event->getId());
        self::assertSame(1234567890, $event->getTime());
        self::assertSame('République Française', $event->getNewName());
        self::assertSame('FR', $event->getCountry()->getCode());
    ...
    public function testLoadCreateUserEvent(array $ids): void
    {
        ...
        self::assertSame(Event\UserEvent\CreateUserEvent::class, get_class($event));

        /** @var Event\UserEvent\CreateUserEvent $event */
        self::assertSame($eventId, $event->getId());
        self::assertSame(1234567890, $event->getTime());
        self::assertSame($userId, $event->getUser()->getId());
    ...
    public function testLoadEditUserNameEvent(array $ids): void
    {
        ...
        self::assertSame(Event\UserEvent\EditUserNameEvent::class, get_class($event));

        /** @var Event\UserEvent\EditUserNameEvent $event */
        self::assertSame($eventId, $event->getId());
        self::assertSame(1234567890, $event->getTime());
        self::assertSame('Ben', $event->getNewName());
        self::assertSame($userId, $event->getUser()->getId());
