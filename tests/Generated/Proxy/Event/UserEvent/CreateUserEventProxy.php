...
/**
 * Proxy for CreateUserEvent entities.
 * This class is generated automatically. Please do not edit.
 */
class CreateUserEventProxy extends CreateUserEvent implements Proxy
{
    private const __NON_ID_PROPERTIES = ['user', 'time'];
    ...
    public function __get(string $name)
    {
        if (! $this->__isInitialized) {
            ...
            if ($loadProps) {
                $propValues = $this->__gateway->loadProps(CreateUserEvent::class, $this->__identity, $loadProps);

                if ($propValues === null) {
                    throw EntityNotFoundException::entityNotFound(CreateUserEvent::class, $this->__scalarIdentity);
                }
